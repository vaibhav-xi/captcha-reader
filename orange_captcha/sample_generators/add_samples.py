...
OUTPUT_DIR = "/Volumes/samsung_980/projects/captcha-reader/dataset/new_5"
TOTAL_IMAGES = 5
...
def main():
    ...
    print("Existing labels found:", len(used))
    ...
    while generated < TOTAL_IMAGES:
        ...
        if generated % 100 == 0:
            print("Generated new:", generated)

    print("\nDone — generated", generated, "new unique captchas")
