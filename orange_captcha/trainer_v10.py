...
DIR_BASE   = "../dataset/generated_samples_v7"
DIR_TARGET = "../dataset/targeted_images_v2"
...
tgt_imgs,  tgt_y,  tgt_l  = load_set(DIR_TARGET)
...
infer_model.save("ocr_ctc_infer_safe_v10.keras")
print("\nSaved → ocr_ctc_infer_safe_v10.keras")
